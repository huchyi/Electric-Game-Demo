...
public class CustomPaint {
	...
	public CustomPaint() {
		...
		this.mLighnitngGlowPaintBold.setStrokeWidth(6.0F);
	...
	// 画细线�?阴影�?
	public void drawLightning(float x1, float y1, float x2, float y2,int paramInt, Canvas paramCanvas) {
		Random localRandom = new Random();
		int aa = localRandom.nextInt(7);
		if (paramInt < aa) {
